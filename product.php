				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<p>Elektronik: "Produk elektronik ini adalah solusi modern untuk kebutuhan teknologi Anda. Dengan fitur-fitur canggih dan performa yang handal, produk ini memungkinkan Anda untuk menikmati pengalaman yang lebih baik dalam berbagai aktivitas, mulai dari hiburan hingga pekerjaan."</p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Pakaian: "Pakaian ini adalah pilihan yang nyaman dan bergaya untuk melengkapi koleksi pakaian Anda. Desainnya yang sederhana dan kualitas bahan yang baik membuatnya cocok untuk berbagai kesempatan dan gaya berpakaian."</p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
